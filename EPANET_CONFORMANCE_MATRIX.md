...
| `conformance-import-quality-mixing-reactions-canonical-units` | Complete-mix, two-compartment, FIFO, and LIFO tanks plus global/entity reactions, independent pipe bulk/wall overrides, tank override ranges, limiting concentration, roughness correlation, zero/positive/negative reaction orders, and `ug/L`-to-`mg/L` coefficient scaling are reconstructed and native-compared |
