...
- `import_quality_trace.inp` exercises TRACE mode, trace-node UUID resolution, percent tolerance, quality timestep, non-default relative diffusivity, native quality equivalence, and import/export/native-reopen round-trip fidelity.
